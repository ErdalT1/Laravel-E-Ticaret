        ...
        <div class="row">
          <div class="col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0" data-aos="fade" data-aos-delay="">
            <a class="block-2-item" href="{{route('kadinurunler')}}">
              ...
              <div class="text">
                <span class="text-uppercase">Koleksiyonlarımız</span>
                <h3>Kadın</h3>
              </div>
            </a>
          </div>
      ...
      <div class="container">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-12 col-lg-5 text-center pl-md-5">
            ...
            <p>Sepete eklediğin üründe %50 indirim fırsatı ayağına geldi. Hemen alışverişe başla ve kampanyalardan yararlanma fırsatını kaçırma!</p>
            <p><a href="{{route('indirimdekiurunler')}}" class="btn btn-primary btn-sm">Alışverişe Başla</a></p>
          </div>
        </div>
      </div>
    </div>
